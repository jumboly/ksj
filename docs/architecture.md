...
src/ksj/
  ...
  reader/
    ...
    integrated.py          # 統合済み GeoPackage / GeoParquet の読み戻し (convert で使用)
  integrator/
    __init__.py
  ...
  writer/
    ...
    parquet.py             # pyarrow で GeoParquet 書出、key_value_metadata に ksj_metadata キー埋込
...
- **pyogrio, geopandas, shapely** — Shapefile/GML/GeoJSON/GPKG/GeoParquet の読書
- **pyproj** — CRS 変換
