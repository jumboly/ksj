...
src/ksj/
  ...
  catalog/
    ...
    schema.py              # pydantic モデル: Catalog / Dataset / Version / FileEntry
                           #   + LicenseProfile / UseCase Literal
    ...
    _normalizers.py        # CRS / format / scope / license / geometry_types の正規化
  downloader/
    __init__.py
...
| `catalog` | データセットメタ・URL・CRS・形式・LicenseProfile の管理と再スクレイプ。datasets.yaml + annotations.yaml の merge も担当 | pydantic, pyyaml, beautifulsoup4, lxml, httpx |
